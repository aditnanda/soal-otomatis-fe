                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-full"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                @livewire('katalog.ppob.pascabayar.pricelist.form')
                            </div>
                        ...
                        <div class="col-md">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>{{$user['code']}}</td>
                                    <td>{{$user['name']}}</td>
                                    <td>{{App\Http\Controllers\Controller::rupiah($user['fee'])}}</td>
                                    <td>{{App\Http\Controllers\Controller::rupiah($user['komisi'])}}</td>
