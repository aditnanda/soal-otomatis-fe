                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-full"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                @livewire('katalog.ppob.prabayar.pricelist.form')
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td><img src="{{$user['icon_url']}}" alt="" srcset="" class="img-fluid"></td>
                                    <td>{{$user['product_type']}}</td>
                                    <td>{{$user['product_code']}}</td>
                                    <td>{{$user['product_description']}}</td>
                                    <td>{{$user['product_nominal']}}</td>
                                    <td>{{$user['product_details']}}</td>
                                    <td>{{App\Http\Controllers\Controller::rupiah($user['product_price'])}}</td>
