                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-full"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                @livewire('koperasi.master-biaya-simpanan-wajib.form')
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md">
                            ...
                            <table class="table">
                                ...
                                @foreach ($biaya_simpanan_wajib as $user)
                                <tr>
                                    <td>{{$user['nama']}}</td>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                {{$biaya_simpanan_wajib->links()}}
                
                            </div>
                            <div class="col-md-2">
                                <small>{{$biaya_simpanan_wajib->total()}} Total Items</small>
