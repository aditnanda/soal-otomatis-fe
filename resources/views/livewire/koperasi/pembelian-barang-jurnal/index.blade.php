<div>
    ...
    <section class="section">
        <hr>
        <h6>Pelunasan Pembelian Barang</h6>
        <div class="row">
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-full"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                @livewire('koperasi.pembelian-barang-jurnal.form',['pembelian' => $pembelian])
                            </div>
            ...
            <div class="col-md-12">
                    <div class="form-group row">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @php
                                        $nominal = 0;
                                    @endphp
                                    @foreach ($pembelian_barang_jurnal as $user)
                                    @php
                                ...
                                <tfoot>
                                    <tr>
                                        <th>&nbsp;</th>
                                        <th>{{App\Http\Controllers\Controller::rupiah($nominal)}}</th>
                                        <th>&nbsp;</th>
                                        <th>&nbsp;</th>
                                    </tr>
                                </tfoot>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                {{$pembelian_barang_jurnal->links()}}
                
                            </div>
                            <div class="col-md-2">
                                <small>{{$pembelian_barang_jurnal->total()}} Total Items</small>
