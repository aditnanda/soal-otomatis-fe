    ...
    <section class="section">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <a type="button" class="btn btn-success" href="{{route('koperasi.pembelian_barang.tambah')}}">
                    Tambah Data
                </a>                
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md">
                            ...
                            <table class="table">
                                ...
                                @foreach ($pembelian_barang as $usr)
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                              <button class="dropdown-item" wire:click="edit('{{\Crypt::encrypt($usr['id'])}}')">Edit</button>
                                              <button class="dropdown-item" wire:click="delete('{{$usr['id']}}')" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini, tindakan ini menghapus data dan tidak dapat DIBATALKAN?') || event.stopImmediatePropagation()">Hapus</button>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                {{$pembelian_barang->links()}}
                
                            </div>
                            <div class="col-md-2">
                                <small>{{$pembelian_barang->total()}} Total Items</small>
