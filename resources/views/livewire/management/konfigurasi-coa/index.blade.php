    ...
    <section class="section">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <a type="button" class="btn btn-success" href="{{route('management.konfigurasi_coa.tambah')}}">
                    Tambah Data
                </a>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-full"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                @livewire('management.konfigurasi-coa.form')
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td>{{$user[0]['nama_konfigurasi_coa']}}</td>
                                    <td>{{$user[0]['keterangan']}}</td>
                                    {{-- <td>{{@$user['master_data_jenis_transaksi_id']['nama_jenis_transaksi']}}</td> --}}
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                              <button class="dropdown-item" wire:click="edit('{{\Crypt::encrypt($user[0]['nama_konfigurasi_coa'])}}')">Edit</button>
