        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <label for="">Nama Konfigurasi COA</label>
                    <input type="text" class="form-control" placeholder="Nama Konfigurasi COA"
                        wire:model="nama_konfigurasi_coa" {{($updateMode) ? 'readonly' : ''}}>
                    @error('nama_konfigurasi_coa')
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label for="">Master Data Jenis Transaksi</label>
                    <select type="text" class="form-control" placeholder="Master Data Jenis Transaksi"
                        wire:model="master_data_jenis_transaksi_id">
                        <option value="">Pilih ...</option>
                        @foreach ($master_data_jenis_transaksi as $item)
                            <option value="{{$item['id']}}">{{$item['nama_jenis_transaksi']}}</option>
                        @endforeach
                    </select>
                    @error('master_data_jenis_transaksi_id')
                        <span class="text-danger error">{{ $message }}</span>
                    @enderror
                </div>
            </div>
        ...
        <form>
            <div class=" add-input">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="">Nominal (untuk simulasi)</label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <input type="number" class="form-control" placeholder="Persen" min="0" max="100"
                                wire:model="persen.0">
                            @error('persen.' . 0)
                                <span class="text-danger error">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <input type="number" class="form-control" placeholder="Nominal"
                                wire:model="nominal.0" value="10000" readonly>
                            @error('nominal.' . 0)
                                <span class="text-danger error">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class=" add-input">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="number" class="form-control" placeholder="Nominal"
                                    wire:model="nominal.{{$value}}" value="10000" readonly>
                                @error('nominal.' . $value)
                                    <span class="text-danger error">{{ $message }}</span>
                                @enderror
                            </div>
