        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <button onclick="exportTableToExcel('tblData','{{'simpanan_pokok_'.$tgl_awal.'_'.$tgl_akhir}}')" class="form-control btn btn-success" >Excel</button>
                        ...
                        <div class="col-md">
                            ...
                            <table class="table" id="tblData">
                                ...
                                <tr>
                                    ...
                                    <td>{{$user['name']}}</td>
                                    <td>{{ App\Http\Controllers\Controller::rupiah(@$user['simpanan_pokok_member']['nominal'])}}</td>


                                </tr>
                                @php
                                    $tot += @$user['simpanan_pokok_member']['nominal'];
                                @endphp
                                @endforeach
                                <tr>
