                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-full"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                @livewire('master-badge.investor-level.form')
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td>{{$user['nama']}}</td>
                                    <td><img src="{{$base_url.$user['ikon']}}" alt="" srcset="" height="100px;"></td>
                                    <td><img src="{{$base_url.$user['bg_ikon']}}" alt="" srcset="" height="100px;"></td>
                                    <td>{{number_format($user['min'],0,',','.')}}</td>
                                    <td>{{number_format($user['max'],0,',','.')}}</td>
